...
<div class='container'>
	<div class="row">
			<div class="col-lg-12"><h3 class="page-header">Add (Unlimited) Virtual Product</h3></div>
	</div>
	...
	<input type="hidden" id='prod_qty' name="prod_qty" value='0000'>
	<input type="hidden" id='prod_weight' name="prod_weight" value='0000'>
	<input type="hidden" id='prod_combine_code' name="prod_combine_code" value=''>
	<input type="hidden" id='prod_reorder_qty' name="prod_reorder_qty" value='0000'>
	<input type="hidden" id="prod_type" name="prod_type" value="{{$product_type->id}}">
	{!! Form::token() !!}
	{!! Form::close() !!}
</div>
