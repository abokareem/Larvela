...
<div class="container">
	...
	<div class="row">
		...
		<div class="form-group">
			...
			<div class="col-xs-12 col-sm-8">
				<input type="text" class="form-control" id="store_address2" name="store_address2" value="{{ $store->store_address2}}"/>
		 	</div>
		</div>
		...
		<div class="form-group">
			<label class="control-label col-xs-12 col-sm-2">Store Theme:</label>
			<div class="col-xs-12 col-sm-5">
				<input type="text" class="form-control" id="store_theme" name="store_theme" value="{{ $store->store_theme }}"/>
		 	</div>
		</div>
		<div class="form-group">
