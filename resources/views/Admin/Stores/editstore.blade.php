...
<div class='container'>
	...
	<div class="row">
		<div class="form-group">
			<label class="control-label col-xs-2">Store Code::</label>
			<div class="col-xs-2">
				<input type="text" class="form-control" id='store_env_code' name="store_env_code" value='{{ $store->store_env_code }}'/>
		 	</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<div class="col-xs-6">
				<input type="text" class="form-control" name="store_url" id='store_url' value="{{ $store->store_url }}">
		 	</div>
		</div>
		<div class="form-group">
