...
<div class='container'>
	<div class="row">
		<div class="col-lg-12"><h3 class="page-header">Add New Attribute</h3></div>
	</div>
	...
	<div class="row">
		<div class="form-group">
			...
			<div class="col-xs-12 col-md-8">
				<input type="text" class="form-control" id='attribute_name' name="attribute_name" value='' placeholder="Enter the attribute name that will display">
		 	</div>
		</div>
		<div class="form-group">
			<label class="control-label col-xs-12 col-md-2">Token:</label>
			<div class="col-xs-12 col-md-4">
				<input type="text" class="form-control" id='attribute_token' name="attribute_token" value='' style="text-transform:uppercase" placeholder="Enter unique token to identify this attribute.">
		 	</div>
		</div>
		<div class="form-group">
	...
	<div class="row">
		<div class="form-group">
			...
			<div class="col-xs-6">
				<button id='btnsave'   type="button" class="btn btn-success">Add Attribute</button>
...
{
	$('#edit').attr('action','/admin/attribute/save');
	$('#edit').submit();
});
