...
<div class="container-fluid">
	<span class="text-left"><a href="https://larvela.org/"><img src="/logos/larvela-logo.jpg"></a></span>
	<br>
	<i style="padding-left:35px;font-family:'Roboto',sans-serif;color:#3700B3;font-size:13px;font-weight:bold;">Installer....</i>
	<div class="row" style="padding-top:30px;">
		<div class="col-xs-12 col-sm-2">&nbsp;</div>
		<div class="col-xs-12 col-sm-6"> @yield('header-step') </div>
	</div>
</div>
@yield('content')
<script src="//maxcdn.bootstrapcdn.com/bootstrap/3.3.6/js/bootstrap.min.js"></script>

@if( view()->exists('Install.install-footer') )
@include('Install.install-footer')
@endif
</body>
</html>
