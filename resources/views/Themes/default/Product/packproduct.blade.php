...
<?php
#
# This page renders a PACK product. It is passed the following variables:
#
# Object   $product - product object - need QTY for pack size
# Array    $images - Array of image objects of Parent
...
<?php
$main_image_folder_name ="/";
$main_image_file_name =$product->id."-1.jpg";
	...
	<div class="row">
		...
		<div class="col-xs-12 col-sm-6 col-md-8">
			...
			<div class="prodpage-qty-block">
				...
				@if($product->prod_type == 5)
<?php
#
# $product_attributes has Colour, product id etc in it as well.
#
	$attr_id = 0;
	foreach($attributes as $attr)
	{
		echo "<span style='font-size:16px;color:green; font-weight:bold'>".$attr->attribute_name."</span>";
		echo "<select name=\"attr-".$attr->id."\" class=\"form-control\">";
		foreach($attribute_values as $av)
		{
			if($av['attr_id'] == $attr->id)
			{
				echo "<option value=\"".$av['id']."\">".$av['attr_value']."</option>";
			}
		}
		echo "</select>";
	}
