	...
	<div class="row cartpage-block"">
		<div class="col-sm-12 col-md-10 col-md-offset-1">
			...
			<table class="table">
				<tbody>
					<tr>
						<td class="text-right"><a href="/"> <button type="button" class="btn btn-default"><span class="fa fa-shopping-cart"></span> Continue Shopping </button></a></td>
						<td><button type="button" class="btn btn-success" id='paypal-button'> Pay Now <span class="fa fa-play"></span></button></td>
					</tr>
					<tr>
						<td class="text-right"><b style='font-size:18px;color:red;'>Payment Gateway Down</b></td>
					</tr>
				</tbody>
			</table>
		</div>
...
paypal.Button.render({
	...
	{
		console.log("payment()");
		console.log("Dumping DATA %o"+data);
		console.log("Dumping ACTIONS %o"+actions);
		return actions.payment.create(
		{
			payment:
			{
				transactions:[{amount:{total:'{{ number_format($total,2) }}',currency:'AUD'}}]
			}
		});
	},
