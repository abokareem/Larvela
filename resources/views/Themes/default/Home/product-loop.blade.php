...
<div class="row">
  <div class="col-xs-2">
  	@if(sizeof($sizes) > 0)
  	<div clas="panel">
		<div class="panel-header" style="font-size:18px;">Shop by Size</div>
		<div class="panel-body">
		<ul class="list-group">
		@foreach($sizes as $size)
			<li style="list-style-type:none;"><a href='/attribute/{{$size->id}}'>{{ $size->attr_value }}</a></li>
		@endforeach
		</ul>
		</div>
	</div>
	@endif
  	...
  	@if(sizeof($colours) > 0)
  	<div clas="panel">
		<div class="panel-header" style="font-size:18px;">Shop by Colour</div>
		<div class="panel-body">
		<ul class="list-group">
		@foreach($colours as $c)
			<li style="list-style-type:none;"><a href='/attribute/{{$c->id}}'>{{ $c->attr_value }}</a></li>
		@endforeach
		</ul>
		</div>
	</div>
