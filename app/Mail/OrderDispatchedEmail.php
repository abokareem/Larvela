 ...
 * OrderDispatchedEmail - The customer's order has been dispatched, send them an email using the mailable interface.
 */
namespace App\Mail;
...
/**
 * \brief Send a templated email confirming that the order has been dispatched.
 */
...
public $hash;
    ...
    {
		$subject = $this->store->store_name." - Order #".$this->order->id." dispatched!";
