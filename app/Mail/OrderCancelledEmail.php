 ...
 * OrderCancelledEmail - The order has been cancelled, so email the customer.
 */
namespace App\Mail;
...
/**
 * \brief The order has been cancelled, so email the customer.
 */
...
public $hash;
    ...
    {
		$subject = $this->store->store_name." - Order #".$this->order->id." cancelled!";
